...
// ═══════════════════════════════════════════════════════════════════
// REMOVED — Project Pitch moved to Mission Control.
// ═══════════════════════════════════════════════════════════════════

const CONSOLE_URL = "https://www.prototypeflx.com/";

export default function ProjectPitchMoved() {
  useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18, maxWidth: 480, padding: 32, textAlign: "center" }}>
        ...
        <div style={{ color: "#8a92b0", fontSize: 13, lineHeight: 1.6, fontFamily: "Rajdhani, sans-serif" }}>
          Project pitching now lives in <b style={{ color: "#fff" }}>Mission Control → Pitches</b>.
          X-Coin keeps your wallet, badges, fines, and marketplace.
        </div>
