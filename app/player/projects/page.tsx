...
// ═══════════════════════════════════════════════════════════════════
// REMOVED — My Projects moved to Mission Control.
// ═══════════════════════════════════════════════════════════════════

const CONSOLE_URL = "https://www.prototypeflx.com/";

export default function MyProjectsMoved() {
  useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18, maxWidth: 480, padding: 32, textAlign: "center" }}>
        ...
        <div style={{ color: "#8a92b0", fontSize: 13, lineHeight: 1.6, fontFamily: "Rajdhani, sans-serif" }}>
          Your projects now live in <b style={{ color: "#fff" }}>Mission Control → Projects</b>.
          Submit, manage, and track them there. X-Coin remains your wallet, badges, fines, and marketplace.
        </div>
